...
import com.estudando.cursomc.domain.Pagamento;
import com.estudando.cursomc.domain.PagamentoComBoleto;
import com.estudando.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lukasaranhalike3@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Jesus", "lucinhasaranha@gmail.com", "45118846099", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida dos Senhores", "2100", null, "Centro", "34777012", cli2, c2);

		cli1.getEnderecos().addAll(Arrays.asList(e1, e2, e3));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("3123123", "21535632"));
